...
(function(Game) {
  ...
  (function(Block) {
    var fra;
    Game.addAction("preconfigure", function() {
      return fra = Game.FrameSelector.complex("blo", Game.Resources.texgam, 200, 974);
    });
    var typ = [];
    var ena = [];
...
(function(Game) {
  ...
  (function(CeilPatroller) {
    ...
    var anifal;
    Game.addAction("configure", function() {
      anifal = new Utils.Animation("fal", false, CeilPatroller.fra, 5, [1, 2, 3, 4, 5, 6, 7, 8], null);
    });
...
(function(Game) {
  ...
  (function(CeilPatroller) {
    ...
    var aniwal;
    Game.addAction("configure", function() {
      aniwal = new Utils.Animation("wal", true, CeilPatroller.fra, 7, [1, 2, 3, 4, 5, 6, 7, 8], null);
    });
    var vel = [];
    var patbox = [];
    var fliaby = [];
...
(function(Game) {
  ...
  spr.enabled = spr.pinned = true;
  Game.addAction("init", function() {
    Game.FrameSelector.complex("titlab", Game.Resources.texgam, 716, 202, null, 0, false)[0].applyToSprite(spr);
  });
...
(function(Game) {
  ...
  (function(WallPatroller) {
    ...
    var anifal;
    Game.addAction("configure", function() {
      anifal = new Utils.Animation("fal", false, WallPatroller.fra, 5, [1, 2, 3, 2], null);
    });
...
(function(Game) {
  ...
  (function(WallPatroller) {
    ...
    var aniwal;
    Game.addAction("configure", function() {
      aniwal = new Utils.Animation("wal", true, WallPatroller.fra, 7, [1, 2, 3, 2], null);
    });
    var vel = [];
    var patbox = [];
    var fliaby = [];
...
(function(Game) {
  ...
  (function(Goal) {
    ...
    var coipar = /** @class */ (function(_super) {
      ...
      coipar.prototype.onDrawLance = function() {
        this.sprite.render();
      };
...
(function(Game) {
  ...
  (function(pla) {
    ...
    Game.addAction("init", function() {
      pla.aniasc = new Utils.Animation("asc", false, pla.fra, 2, [7, 8], null);
    });
...
(function(Game) {
  ...
  (function(pla) {
    ...
    Game.addAction("init", function() {
      pla.anifal = new Utils.Animation("fal", false, pla.fra, 2, [9, 10, 11], null);
    });
...
(function(Game) {
  ...
  (function(pla) {
    ...
    Game.addAction("init", function() {
      pla.aniwal = new Utils.Animation("wal", true, pla.fra, 7, [5, 6, 5, 4], null);
    });
