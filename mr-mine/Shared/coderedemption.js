...
function onCouponSuccess(coupon)
{
	...
	switch(rewardType)
	{
		...
		case "miner_speed_potion_buff":
			rewardValue = parseInt(coupon.value);
			buffs.startBuff(0, rewardValue, "code");
			rewardMessage = _("You gained a buff!");
			break;
		case "key_of_luck_buff":
			rewardValue = parseInt(coupon.value);
			buffs.startBuff(1, rewardValue, "code");
			rewardMessage = _("You gained a buff!");
			break;
		case "midas_touch_buff":
			rewardValue = parseInt(coupon.value);
			buffs.startBuff(2, rewardValue, "code");
			rewardMessage = _("You gained a buff!");
			break;
		case "elemental_pike_buff":
			rewardValue = parseInt(coupon.value);
			buffs.startBuff(3, rewardValue, "code");
			rewardMessage = _("You gained a buff!");
			break;
		case "nugget_of_attraction_buff":
			rewardValue = parseInt(coupon.value);
			buffs.startBuff(4, rewardValue, "code");
			rewardMessage = _("You gained a buff!");
			break;
		case "drill_speed_potion_buff":
			rewardValue = parseInt(coupon.value);
			buffs.startBuff(5, rewardValue, "code");
			rewardMessage = _("You gained a buff!");
			break;
		case "raining_chests_buff":
			rewardValue = parseInt(coupon.value);
			buffs.startBuff(6, rewardValue, "code");
			rewardMessage = _("You gained a buff!");
			break;
		case "cargo_expansion_buff":
			rewardValue = parseInt(coupon.value);
			buffs.startBuff(7, rewardValue, "code");
			rewardMessage = _("You gained a buff!");
			break;
		case "endless_gem_speed_potion_buff":
			rewardValue = parseInt(coupon.value);
			buffs.startBuff(8, rewardValue, "code");
			rewardMessage = _("You gained a buff!");
			break;
		case "relic_effectiveness_buff":
			rewardValue = parseInt(coupon.value);
			buffs.startBuff(9, rewardValue, "code");
			rewardMessage = _("You gained a buff!");
			break;
