class HintHighlight extends Hitbox
{
    ...
    render()
    {
        if(showHintArrows)
        {
            ...
            // Use cached rendering for better mobile performance if available
            if(typeof drawCachedHintHighlight === 'function')
            {
                drawCachedHintHighlight(
                    this.rootContext,
                    coords.x,
                    coords.y,
