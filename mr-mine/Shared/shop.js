...
const IngamePurchaseSubcategories = Object.freeze({
    TRADE_REROLL: 0,
    TRADE_EXTENSION: 1,
    EXCAVATION_REROLL: 2,
    SCIENTIST_RESURRECTION: 3,
    BASIC_CHEST_PURCHASE: 4,
    GOLD_CHEST_PURCHASE: 5,
    CAVE_EXTENSION: 6,
    CHEST_SKIP: 7,
    RELIC_SLOT_PURCHASE: 8,
    AD_PROMPT_SKIP: 9,
    BUFF_EXTENSION: 10,
})
...
class BaseShopItem
{
    ...
    onPurchase()
    {
        ...
        subtractTickets(this.getCost(), this.categoryType, this.subtype);
        playClickSound();
        this.grant();
    }
