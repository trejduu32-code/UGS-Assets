...
};
{
  ...
  const y = new Set(["cordova", "playable-ad-single-file", "playable-ad-zip", "instant-games"]);
  ...
  window.RuntimeInterface = class e {
    ...
    IsiOSWebView() {
      ...
      return t && v(this._exportType) || navigator.standalone || /crios\/|fxios\/|edgios\//i.test(e)
    }
    IsAndroid() {
      return i
    }
    ...
    async _Init(e) {
      if (this._useWorker && (await a() || (this._useWorker = !1)), "macos-wkwebview" === this._exportType && this._SendWrapperMessage({
          type: "ready"
    ...
    async _InitDOM(e, t) {
      ...
      if (a) try {
        if (await o(a), "preview" === this._exportType && !globalThis.C3_ProjectMainScriptOK) throw new Error("main script did not run to completion")
      } catch (e) {
      ...
      if (r) try {
        if (await o(r), "preview" === this._exportType && !globalThis.C3.JavaScriptInEvents) throw new Error("JavaScript in events did not run to completion")
      } catch (e) {
      ...
      if (d) try {
        if (await o(d), "preview" === this._exportType && !globalThis.C3.TypeScriptInEvents) throw new Error("TypeScript in events did not run to completion")
      } catch (e) {
    ...
    H = class extends self.DOMHandler {
      constructor(e) {
        ...
        if (window.addEventListener("contextmenu", e => {
          ...
          }), window.addEventListener("selectstart", I), window.addEventListener("gesturehold", I), window.addEventListener("touchstart", I, {
            passive: !1
      ...
      _AddDefaultCanvasEventHandlers(e) {
        e.addEventListener("selectstart", I), e.addEventListener("gesturehold", I), e.addEventListener("pointerdown", I)
      }
      _AddDefaultHTMLWrapEventHandlers(e) {
        e.addEventListener("selectstart", G), e.addEventListener("gesturehold", G), e.addEventListener("touchstart", G)
      }
      _OnBeforeStartTicking() {
        return self.setTimeout(() => {
          this._enableAndroidVKDetection = !0
        }, 1e3), "cordova" === this._iRuntime.GetExportType() ? (document.addEventListener("pause", () => this._OnVisibilityChange(!0)), document.addEventListener("resume", () => this._OnVisibilityChange(!1))) : document.addEventListener("visibilitychange", () => this._OnVisibilityChange("hidden" === document.visibilityState)), this._pageVisibilityIsHidden = !("hidden" !== document.visibilityState && !L), {
      ...
      Attach() {
        window.addEventListener("focus", () => this._PostRuntimeEvent("window-focus")), window.addEventListener("blur", () => {
          ...
          var t;
          t = e.target, (E.has(t.tagName.toLowerCase()) || A(t)) && this._PostRuntimeEvent("keyboard-blur")
        }), window.addEventListener("keydown", e => this._OnKeyEvent("keydown", e)), window.addEventListener("keyup", e => this._OnKeyEvent("keyup", e)), window.addEventListener("mousedown", e => this._OnMouseEvent("mousedown", e, O)), window.addEventListener("mousemove", e => this._OnMouseEvent("mousemove", e, O)), window.addEventListener("mouseup", e => this._OnMouseEvent("mouseup", e, O)), window.addEventListener("dblclick", e => this._OnMouseEvent("dblclick", e, k)), window.addEventListener("wheel", e => this._OnMouseWheelEvent("wheel", e, k)), window.addEventListener("pointerdown", e => {
      ...
      _OnKeyEvent(e, t) {
        ...
        if ("Backspace" === t.key && I(t), "nwjs" === this._iRuntime.GetExportType() && "u" === t.key && (t.ctrlKey || t.metaKey) && t.preventDefault(), this._isExportToVideo) return;
      ...
      _OnPointerEvent(e, t) {
        ...
        "mouse" === t.pointerType && (i = this._mousePointerLastButtons), this._PostToRuntimeMaybeSync(e, {
          ...
          twist: t.twist || 0,
          timeStamp: t.timeStamp
        }, k), "mouse" === t.pointerType && (this._mousePointerLastButtons = t.buttons)
      }
  ...
  const U = "keyboard",
    B = class extends self.DOMHandler {
      constructor(e) {
        super(e, U), this._isKeyboardLockSupported = !(!navigator.keyboard || !navigator.keyboard.lock), this.AddRuntimeMessageHandlers([
          ["init", () => this._OnInit()],
  ...
  const V = "mouse",
    q = class extends self.DOMHandler {
      constructor(e) {
        super(e, V), this.AddRuntimeMessageHandlers([
  ...
  self.AudioDOMHandler = class extends self.DOMHandler {
    ...
    async _Play(e) {
      const t = e.originalUrl,
        ...
        c = e.stereoPan;
      let h = e.off;
      h > 0 && !e.trueClock && (h += this.GetAudioCurrentTime()), this._lastPlayedTags = o.slice(0), this._AddPendingTags(o);
      try {
        this._lastAudioInstance = await this._GetAudioInstance(t, i, s, o, n), l ? (this._lastAudioInstance.SetPannerEnabled(!0), this._lastAudioInstance.SetPan(l.x, l.y, l.z, l.angle, l.innerAngle, l.outerAngle, l.outerGain), l.hasOwnProperty("uid") && this._lastAudioInstance.SetUID(l.uid)) : "number" == typeof c && 0 !== c ? (this._lastAudioInstance.SetStereoPannerEnabled(!0), this._lastAudioInstance.SetStereoPan(c)) : (this._lastAudioInstance.SetPannerEnabled(!1), this._lastAudioInstance.SetStereoPannerEnabled(!1)), this._lastAudioInstance.Play(a, r, d, h)
      } catch (e) {
    ...
    async _LoadAudioInstance(e, t) {
      ...
      let c = null;
      try {
        c = await this._GetAudioInstance(i, s, n, a, o)
      } catch (e) {
        return void console.error("[Construct] Audio: error loading audio state: ", e)
      }
      c.LoadPanState(e.pan), c.LoadStereoPanState(e.stereoPan), c.Play(r, d, l, 0), e.isPlaying || c.Pause(), c._LoadAdditionalState(e)
    }
...
};
{
  ...
  self.C3AudioFilterFX = class extends $ {
  ...
  }, self.C3AudioDelayFX = class extends $ {
    constructor(e, t, i, s) {
  ...
  }, self.C3AudioConvolveFX = class extends $ {
    constructor(e, t, i, s) {
  ...
  }, self.C3AudioFlangerFX = class extends $ {
  ...
  }, self.C3AudioPhaserFX = class extends $ {
    constructor(e, t, i, s, n, o, a) {
  ...
  }, self.C3AudioGainFX = class extends $ {
    constructor(e, t) {
  ...
  }, self.C3AudioStereoPanFX = class extends $ {
    constructor(e, t) {
  ...
  }, self.C3AudioTremoloFX = class extends $ {
    constructor(e, t, i) {
  ...
  }, self.C3AudioRingModFX = class extends $ {
    constructor(e, t, i) {
  ...
  }, self.C3AudioDistortionFX = class extends $ {
    constructor(e, t, i, s, n, o) {
  ...
  }, self.C3AudioCompressorFX = class extends $ {
    constructor(e, t, i, s, n, o) {
    ...
    SetParam(e, t, i, s) {}
  }, self.C3AudioAnalyserFX = class extends $ {
    constructor(e, t, i) {
  ...
  function te() {}
  window.addEventListener("beforeinstallprompt", e => (e.preventDefault(), J = e, Q && Q._OnBeforeInstallPrompt(), !1));
  const ie = "browser",
    se = class extends self.DOMHandler {
      constructor(e) {
        super(e, ie), this._exportType = "", this.AddRuntimeMessageHandlers([
      ...
      Attach() {
        J ? this._OnBeforeInstallPrompt() : Q = this, window.addEventListener("appinstalled", () => this._OnAppInstalled())
      }
      ...
      async _OnRequestInstall() {
        ...
        try {
          return J.prompt(), {
            result: (await J.userChoice).outcome
          }
        } catch (e) {
      ...
      _OnExitFullscreen() {
        if (this._iRuntime.IsAnyWebView2Wrapper() || "macos-wkwebview" === this._exportType || "linux-cef" === this._exportType) self.RuntimeInterface._SetWrapperIsFullscreenFlag(!1), this._iRuntime._SendWrapperMessage({
          ...
          let e;
          document.exitFullscreen ? e = document.exitFullscreen() : document.mozCancelFullScreen ? e = document.mozCancelFullScreen() : document.msExitFullscreen ? e = document.msExitFullscreen() : document.webkitCancelFullScreen && (e = document.webkitCancelFullScreen()), e instanceof Promise && e.catch(te)
        }
      }
      _OnSetHash(e) {
  ...
  const le = class extends self.DOMHandler {
    constructor(e) {
      super(e, ne), this.AddRuntimeMessageHandlers([
    ...
    async _GetSafeAreaInset() {
      ...
      try {
        return await Promise.all([oe(e), ae(e), re(e), de(e)])
      } catch (e) {
  ...
  self.RuntimeInterface.AddDOMHandlerClass(le)
} {
  const ce = "localstorage",
    he = class extends self.DOMHandler {
      constructor(e) {
        super(e, ce), this.AddRuntimeMessageHandlers([
          ["init", () => this._Init()],
  ...
  async function _e(e, t, i) {
    const s = await e.createWritable({
      keepExistingData: !!i
    });
    if (i) {
  ...
  function me(e) {
    let t = e.replaceAll("\\", "/");
    return t.startsWith("/") && (t = t.substring(1)), t.endsWith("/") && (t = t.substring(0, t.length - 1)), t
  }
  async function pe(e, t) {
    "prompt" === await e.queryPermission({
      mode: t
    }) && await e.requestPermission({
      mode: t
    })
  }
  const fe = ["<app>", "<web-resource>", "<current-app-data>", "<local-app-data>", "<roaming-app-data>", "<desktop>", "<documents>", "<downloads>", "<pictures>", "<profile>", "<saved-games>", "<screenshots>", "<videos>"],
    ge = class extends self.DOMHandler {
      constructor(e) {
        super(e, ue), this._pickerMap = new Map, this.AddRuntimeMessageHandlers([
          ["init", e => this._Init(e)],
          ["show-save-file-picker", e => this._ShowSaveFilePicker(e)],
          ["show-open-file-picker", e => this._ShowOpenFilePicker(e)],
          ["show-folder-picker", e => this._ShowFolderPicker(e)],
          ["write-text-file", e => this._WriteTextFile(e)],
          ["write-binary-file", e => this._WriteBinaryFile(e)],
          ["read-text-file", e => this._ReadTextFile(e)],
          ["read-binary-file", e => this._ReadBinaryFile(e)],
          ["create-folder", e => this._CreateFolder(e)],
          ["copy-file", e => this._CopyFile(e)],
          ["delete", e => this._Delete(e)],
          ["list-content", e => this._ListContent(e)]
        ])
      }
      _Init(e) {
        const t = e.pickerMap;
        t && (this._pickerMap = t);
        const i = this._iRuntime._GetDirectoryHandles(),
          s = new Set;
        for (let e = 0, t = Math.min(i.length, fe.length); e < t; ++e) {
          const t = i[e],
            n = fe[e];
          t && (this._pickerMap.set(n, [t]), s.add(n))
        }
        return {
          isFSAPISupported: !!window.showSaveFilePicker,
          additionalPickerTags: s,
          builtInPickerTags: fe
        }
      }
      async _ShowSaveFilePicker(e) {
        const t = e.pickerTag,
          i = e.pickerOpts;
        try {
          const e = await window.showSaveFilePicker(i);
          return this._pickerMap.set(t, [e]), this._SavePickerMap(), {
            isOk: !0,
            pickedFileNames: [e.name]
          }
        } catch (e) {
          return console.warn("[Construct] Error showing save file picker: ", e), {
            isOk: !1
          }
        }
      }
      async _ShowOpenFilePicker(e) {
        const t = e.pickerTag,
          i = e.pickerOpts;
        try {
          ...
          return this._pickerMap.set(t, e), this._SavePickerMap(), {
            isOk: !0,
            pickedFileNames: e.map(e => e.name)
          }
        } catch (e) {
          return console.warn("[Construct] Error showing open file picker: ", e), {
            isOk: !1
          }
        }
      }
      async _ShowFolderPicker(e) {
        const t = e.pickerTag,
          i = e.pickerOpts;
        try {
          const e = await window.showDirectoryPicker(i);
          return this._pickerMap.set(t, [e]), this._SavePickerMap(), {
            isOk: !0,
            pickedFolderNames: [e.name]
          }
        } catch (e) {
          return console.warn("[Construct] Error showing folder picker: ", e), {
            isOk: !1
          }
        }
      }
      _SavePickerMap() {
        this.PostToRuntime("save-picker-map", {
          pickerMap: this._pickerMap
        })
      }
      async _FollowPath(e, t, i) {
        const s = t.split("/"),
          n = s.pop();
        for (const t of s) e = await e.getDirectoryHandle(t, {
          create: i
        });
        return {
          folderHandle: e,
      ...
      async _GetFileHandleFor(e, t, i) {
        const s = this._pickerMap.get(e);
        if (!Array.isArray(s) || 0 === s.length) throw new Error(`nothing picked for tag '${e}'`);
        if (1 === s.length && "directory" === s[0].kind) {
          const e = s[0];
          if (await pe(e, i ? "readwrite" : "read"), !(t = me(t))) throw new Error("empty folder path");
          const n = await this._FollowPath(e, t, i);
          return await n.folderHandle.getFileHandle(n.lastName, {
            create: i
          })
        }
        if (1 !== s.length || t) {
          for (const e of s)
            if (e.name === t) return await pe(e, i ? "readwrite" : "read"), e;
          throw new Error(`no file with name '${t}'`)
        } {
          const e = s[0];
          return await pe(e, i ? "readwrite" : "read"), e
        }
      }
      async _GetFolderHandleFor(e, t, i) {
        const s = this._pickerMap.get(e);
        if (!Array.isArray(s) || 0 === s.length) throw new Error(`nothing picked for tag '${e}'`);
        if (1 === s.length && "directory" === s[0].kind) {
          const e = s[0];
          return await pe(e, i ? "readwrite" : "read"), t = me(t), await this._FollowPath(e, t, i)
        }
        throw new Error(`picker tag '${e}' is not for a folder`)
      }
      async _WriteTextFile(e) {
        const t = e.pickerTag,
          i = e.folderPath,
          s = e.text,
          n = e.keepExisting;
        try {
          const e = await this._GetFileHandleFor(t, i, !0);
          return await _e(e, s, n), {
            isOk: !0
          }
        } catch (e) {
          return console.error("[Construct] Error writing text file: ", e), {
            isOk: !1
          }
        }
      }
      async _WriteBinaryFile(e) {
        const t = e.pickerTag,
          i = e.folderPath,
          s = e.arrayBuffer;
        try {
          ...
          return console.error("[Construct] Error writing binary file: ", e), {
            isOk: !1
          }
        }
      }
      async _ReadTextFile(e) {
        const t = e.pickerTag,
          i = e.folderPath;
        try {
          const e = await this._GetFileHandleFor(t, i, !1),
            s = await e.getFile();
          return {
            isOk: !0,
            text: await s.text()
          ...
          return console.error("[Construct] Error reading text file: ", e), {
            isOk: !1
          }
        }
      }
      async _ReadBinaryFile(e) {
        const t = e.pickerTag,
          i = e.folderPath;
        try {
          const e = await this._GetFileHandleFor(t, i, !1),
          ...
          return console.error("[Construct] Error reading binary file: ", e), {
            isOk: !1
          }
        }
      }
      async _CreateFolder(e) {
        const t = e.pickerTag,
          i = e.folderPath;
        try {
          const {
            folderHandle: e,
            lastName: s
          } = await this._GetFolderHandleFor(t, i, !0);
          if (!s) throw new Error("empty folder path");
          return await e.getDirectoryHandle(s, {
            create: !0
          }), {
            isOk: !0
          }
        } catch (e) {
          return console.error("[Construct] Error creating folder: ", e), {
            isOk: !1
          }
        }
      }
      async _CopyFile(e) {
        const t = e.pickerTag,
          ...
          s = e.destFolderPath;
        try {
          const e = await this._GetFolderHandleFor(t, s, !0),
            n = await this._GetFolderHandleFor(t, i, !1);
          if (!n.lastName || !e.lastName) throw new Error("empty folder path");
          const o = await n.folderHandle.getFileHandle(n.lastName, {
              create: !1
            }),
            a = await e.folderHandle.getFileHandle(e.lastName, {
              create: !0
            }),
            r = await o.getFile(),
            d = await a.createWritable();
          return await r.stream().pipeTo(d), {
            isOk: !0
          }
        } catch (e) {
          return console.error("[Construct] Error copying file: ", e), {
            isOk: !1
          }
        }
      }
      async _Delete(e) {
        ...
        try {
          const {
            folderHandle: e,
            lastName: n
          } = await this._GetFolderHandleFor(t, i, !1);
          if (!n) throw new Error("empty folder path");
          return await e.removeEntry(n, {
            recursive: s
          }), {
            isOk: !0
          }
        } catch (e) {
          return console.error("[Construct] Error deleting: ", e), {
            isOk: !1
          }
        }
      }
      async _DoListContent(e, t, i, s, n) {
        const o = [];
        try {
          for await (const n of e.values())
          "file" === n.kind ? s.push(t + n.name) : "directory" === n.kind ? (i.push(t + n.name), o.push(n)) : console.warn(`unknown folder entry kind '${n.kind}' (name '${n.name}')`)
        } catch (e) {
          if (console.warn(`Error listing contents for path '${t}': `, e), "" === t) throw e
        }
        n && await Promise.all(o.map(e => this._DoListContent(e, t + e.name + "/", i, s, n)))
      }
      async _ListContent(e) {
        const t = e.pickerTag,
          i = e.folderPath,
          s = e.isRecursive;
        try {
          ...
          n && (e = await e.getDirectoryHandle(n, {
            create: !1
          }));
          const o = [],
            a = [];
          return await this._DoListContent(e, "", o, a, s), {
            isOk: !0,
            folderNames: o,
            fileNames: a
          }
        } catch (e) {
          return console.error("[Construct] Error listing content: ", e), {
            isOk: !1
          }
        }
      }
  ...
  const we = "pipelabv2",
    ye = class extends self.DOMHandler {
      constructor(e) {
        super(e, we), this.AddRuntimeMessageHandlers([
          ["set-fullscreen", e => this._OnSetFullscreen(e)],
      ...
      _OnSetFullscreen(e) {
        1 === e.state ? document.documentElement.requestFullscreen() : document.fullscreenEnabled && document.exitFullscreen()
      }
      ...
      _setupFullscreenListeners() {
        document.addEventListener("fullscreenchange", () => {
          this._fullscreenState = document.fullscreenElement ? {
            state: 1
          } : {
            state: 0
  ...
  self.RuntimeInterface.AddDOMHandlerClass(ye)
}
if (window.C3_IsSupported) {
  ...
  window.c3_runtimeInterface = new self.RuntimeInterface({
    ...
    runtimeScriptList: ["scripts/c4main.js"],
