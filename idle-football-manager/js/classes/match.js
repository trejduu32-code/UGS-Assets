...
class Match {
  ...
  getNormPower() {
    let att1 = this.team1.getCombinedAttack(),
      def1 = this.team1.getCombinedDefense();
    let att2 = this.team2.getCombinedAttack(),
      def2 = this.team2.getCombinedDefense();
