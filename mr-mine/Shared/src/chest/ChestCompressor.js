class ChestCompressor {
    ...
    grantChestAndRemoveFromQueue(index) {
        ...
        if (chestType == 1) {
            newNews(_("A Gold Chest finished compressing and has been added to your chest storage"), true);
        }
        else if (chestType == 2) {
            newNews(_("An Ethereal Chest finished compressing and has been added to your chest storage"), true);
        }
