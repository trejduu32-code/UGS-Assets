  ...
  getScoreTable(scoreTag, leadingPlayers, includePlayer, playersAround) {
    ...
    try {
      this.wrapperSDK
        ...
        .then((leaderboards) => {
          leaderboards
            .getLeaderboardEntries(scoreTag, {
              quantityTop: leadingPlayers,
