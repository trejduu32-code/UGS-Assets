const FEATURE_GENERATORS = 0,
  FEATURE_RESOURCEBUTTON = 1,
  FEATURE_UPGRADES = 2,
  FEATURE_POWER = 3,
  FEATURE_SIMPLEBOOST = 4,
  FEATURE_CHALLENGES = 5,
  FEATURE_UPGRADE_TREE = 6;
const TARGET_GENERATORS = 0,
  TARGET_POWERGENERATORS = 1;
