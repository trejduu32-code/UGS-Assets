! function(t, e) {
  ...
  return function(t) {
    ...
    ***************************************************************************** */
    ...
    var s = i(0),
      ...
      _ = function() {
        ...
        return t.prototype.copyFrom = function(t) {
          ...
          for (var p = 0; p < 4; p++) t.transformCoordinates(h[p].x, h[p].y, l[p]), u.x = Math.floor(Math.min(u.x, l[p].x)), u.y = Math.floor(Math.min(u.y, l[p].y)), c.x = Math.ceil(Math.max(c.x, l[p].x)), c.y = Math.ceil(Math.max(c.y, l[p].y));
    ...
    s._TypeStore.RegisteredTypes["BABYLON.GUI.Rectangle"] = b,
      function(t) {
    ...
    var y = function(t) {
      ...
      return n(e, t), Object.defineProperty(e.prototype, "lines", {
        ...
        if (n)
          for (; n.length && r > e;) n.pop(), t = n.join("") + "...", r = i.measureText(t).width;
        else
          for (; t.length > 2 && r > e;) t = t.slice(0, -2) + "…", r = i.measureText(t).width;
        return {
          text: t,
          width: r
        }
    ...
    var v = function(t) {
      ...
      return n(e, t), Object.defineProperty(e.prototype, "isLoaded", {
        ...
        if (0 != i) {
          var d = i < 0 ? -1 : 1;
          i %= 4;
          for (var p = 0; p < Math.abs(i); ++p) l = -(s - h / 2) * d + h / 2, u = (o - a / 2) * d + a / 2, c = (r = [_, c])[0], _ = r[1], i < 0 ? u -= _ : l -= c, o = l, s = u, a = (n = [h, a])[0], h = n[1]
        }
        ...
        for (var o = 0; o < i; o++) {
          if ((a = n.data[4 * o + 3]) > 127 && -1 === this._sliceLeft) this._sliceLeft = o;
        ...
        for (var s = 0; s < r; s++) {
          var a;
          if ((a = n.data[s * i * 4 + 3]) > 127 && -1 === this._sliceTop) this._sliceTop = s;
    ...
    var w = function() {
        ...
        return Object.defineProperty(t.prototype, "text", {
          ...
          if (this._characters) {
            ...
            for (var i = [], r = 0; t < e;) i[r++] = this._characters[t++];
            return i.join("")
          }
            ...
            switch (t) {
              ...
              case 8:
                if (this._textWrapper.text && this._textWrapper.length > 0) {
                  ...
                  if (0 === this._cursorOffset) this.text = this._textWrapper.substr(0, this._textWrapper.length - 1);
                  else(r = this._textWrapper.length - this._cursorOffset) > 0 && (this._textWrapper.removePart(r - 1, r), this._textHasChanged())
                }
    ...
    var P = function(t) {
      ...
      return n(e, t), Object.defineProperty(e.prototype, "columnCount", {
        ...
        for (var e = [], i = [], r = [], n = [], o = this._currentMeasure.width, s = 0, a = this._currentMeasure.height, h = 0, l = 0, u = 0, c = this._rowDefinitions; u < c.length; u++) {
          if ((g = c[u]).isPixel) a -= f = g.getValue(this._host), i[l] = f;
        ...
        for (var d = 0, p = this._rowDefinitions; d < p.length; d++) {
          ...
          else _ += f = g.internalValue / h * a, i[l] = f;
          l++
        }
        l = 0;
        for (var m = 0, b = this._columnDefinitions; m < b.length; m++) {
          if ((g = b[m]).isPixel) o -= C = g.getValue(this._host), e[l] = C;
    ...
    var M = function(t) {
      ...
      return n(e, t), Object.defineProperty(e.prototype, "value", {
        ...
        return new Promise((function(r, n) {
          ...
          var o, a, h, l, u, c, _, d, p, g, m, v, C, T, w, M, I, k, A, S = i.swatchLimit / i.numSwatchesPerLine,
          ...
          function z(t, e) {
            var i = t.text;
            if (/[^0-9]/g.test(i)) t.text = k;
            else if ("" != i && (Math.floor(parseInt(i)) < 0 ? i = "0" : Math.floor(parseInt(i)) > 255 ? i = "255" : isNaN(parseInt(i)) && (i = "0")), A == t.name && (k = i), "" != i) {
          ...
          function Y(t, e) {
            if (i.savedColors) {
              ...
              if (d.rowCount != r + n) {
                for (var o = d.rowCount, s = 0; s < o; s++) d.removeRowDefinition(0);
                for (s = 0; s < r + n; s++) s % 2 ? d.addRowDefinition(R, !0) : d.addRowDefinition(D, !0)
              }
              d.height = (R * r + n * D).toString() + "px";
              for (var a = 1, h = 1; a < r + n; a += 2, h++) {
                if (i.savedColors.length > h * i.numSwatchesPerLine) var l = i.numSwatchesPerLine;
                else l = i.savedColors.length - (h - 1) * i.numSwatchesPerLine;
          ...
          if (t.addControl(J), i.savedColors) {
            ...
            for (var et = 0; et < 2 * Math.ceil(i.savedColors.length / i.numSwatchesPerLine) + 1; et++) et % 2 != 0 ? d.addRowDefinition(R, !0) : d.addRowDefinition(D, !0);
            for (et = 0; et < 2 * i.numSwatchesPerLine + 1; et++) et % 2 != 0 ? d.addColumnDefinition(R, !0) : d.addColumnDefinition(D, !0);
            J.addControl(d, 1, 0)
          }
          var it = new P;
          ...
          M.text = Dt[1], M.color = "#f0f0f0", M.background = "#454545", M.onFocusObservable.add((function() {
            ...
            var t = M.text,
              e = /[^0-9A-F]/i.test(t);
            if ((M.text.length > 6 || e) && A == M.name) M.text = k;
            else {
              if (M.text.length < 6)
    ...
    var k = function(t) {
      ...
      return n(e, t), e.prototype._beforeRenderText = function(t) {
        for (var e = new w, i = "", r = 0; r < t.length; r++) i += "•";
        return e.text = i, e
      }, e
    }(x);
    ...
    var B = function() {
      ...
      W = function(t) {
        ...
        return n(e, t), e.prototype._getTypeName = function() {
          ...
          (void 0 === i && (i = function() {}), void 0 === r && (r = "Units"), void 0 === n && (n = 0), void 0 === o && (o = 0), void 0 === s && (s = 0), void 0 === a && (a = function(t) {
            return 0 | t
    ...
    var Z = function() {
        ...
        return n(e, t), Object.defineProperty(e.prototype, "numLayoutCalls", {
          ...
          if (!this._layerToDispose || 0 != (t.layerMask & this._layerToDispose.layerMask)) {
            if (this._isFullscreen && this._linkedControls.length) {
              var e = this.getScene();
              if (!e) return;
              for (var i = this._getGlobalViewport(e), r = function(t) {
      ...
      $ = function() {
        ...
        return t.prototype._getChainElement = function(t) {
          ...
          try {
            ...
            for (var n = 0; n < t.attributes.length; n++)
              if (!t.attributes[n].name.toLowerCase().includes("datasource"))
                ...
                } else if ("linkWithMesh" == t.attributes[n].name) this._parentClass ? r.linkWithMesh(this._parentClass[t.attributes[n].value]) : r.linkWithMesh(window[t.attributes[n].value]);
            else if (t.attributes[n].value.startsWith("{{") && t.attributes[n].value.endsWith("}}")) {
            ...
            if (h[d].nodeType == this._nodeTypes.element) {
              ...
              for (var p = 0; p < o.length; p++)
                if (o[p].nodeType == this._nodeTypes.element) {
                  ...
                  s = o[p].children;
                  for (var f = 0; f < s.length; f++) s[f].nodeType == this._nodeTypes.element && (a = this._createGuiElement(s[f], e, !1), e.addControl(a, u, c), s[f].firstChild && this._parseXml(s[f].firstChild, a))
                } 0 == u && (_ = c), c = -1
          ...
          var s = o[1];
          if (s.startsWith("{") && s.endsWith("}") && (n = !1), (!n || s.startsWith("[") && s.endsWith("]")) && (s = s.substring(1, s.length - 1)), s = this._parentClass ? this._parentClass[s] : window[s], n)
