const UPGRADE_RESOURCE = 0,
  UPGRADE_GENERATOR = 1,
  UPGRADE_GENMULTI = 2,
  UPGRADE_POWERGENERATOR = 3,
  UPGRADE_PRESTIGEREWARD = 4,
  UPGRADE_RESOURCE_TIMELAYER = 5,
  UPGRADE_GENERATOR_TIMELAYER = 6,
  UPGRADE_POWERGENERATOR_TIMELAYER = 7;

const RESOURCE_ALEPH = 0,
  RESOURCE_LAYERCOINS = 1;
...
class TreeUpgrade extends LayerUpgrade {
  constructor(layerCost, layerBoost, getPrice, getEffect, type, requires, blacklist, cfg) {
    ...
    cfg = Object.assign(cfg, {
      requires,
      blacklist
    }); //have at least one required, don't have any blacklisted
